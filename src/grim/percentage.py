...
def part_from_whole_and_percentage(
    percentage: Union[int, float], whole: Union[int, float]
):
    return percentage * whole


def whole_from_part_and_percentage(
    part: Union[int, float], percentage: Union[int, float]
):
...
def ensure_percentage_params(whole, part, percentage):
    return if_whole_is_none(
        if_part_is_none(if_percentage_is_none(whole, part, percentage))
    )
