...
def markov_chain(seq: Sequence[T]) -> Dict[T, Dict[T, float]]:
    ...
    for current_head_item, tail_transition_counts in transitions.items():
        ...
        for current_tail_item, current_transition_count in tail_transition_counts.items():
            probabilities[current_head_item][current_tail_item] = current_transition_count / total
